...
public class JavaScriptUtil {
    ...
    /**
     * This method is used to perform Scroll down end of the page vertically
     */
    ...
    /**
     * This method is used to perform Scroll down by pixel on the page
     */
    public void scrollPageDown(int pixel) {
        JavascriptExecutor js = (JavascriptExecutor) driver;
