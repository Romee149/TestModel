...
import com.qa.ecs.pages.AddDocumentScreen;
...
public class CommonUtil {
	...
	/**
	 * This method is used to verify the Date Time Format for format dd-MM-yyyy
	 * hh:mm:ss am/pm
	 *
	 * @param value in String Format
	 * @return boolean format, True for correct format, False for incorrect format
	...
	/**
	 * This method is used to verify check date is between or equal two date [Return
	 * True if check Date is between 'date1' and 'date2' Otherwise Return False]
	 *
	...
	public String getSSN() {
		if (ssn == null) {
			...
			int low = 100;
			int high = 999;
			ssn = (r.nextInt(high - low) + low) + this.getCurrentDateTime().substring(8);
		}
		return ssn;
	}
	...
	public String getAccountNumber() {
		if (accountNumber == null) {
			accountNumber = this.getCurrentDateTime("ddMMyyHHmmss");
		}
