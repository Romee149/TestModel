...
@JsonPropertyOrder({ "accrInt", "avlInt", "fee", "ledger", "negAccr", "penalty", "wthFed", "wthState",

		"capInt", "depFee", "negBal", "chrgOffBal", "lateChrg", "lnFee", "deferFee", "deferCost", "receivableFee",
