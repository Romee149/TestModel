...
@JsonPropertyOrder({ "_schVn", "ageBracket", "contactPref", "education", "employmentStatus", "ethnicity",
		"familiarName", "gender", "incBracket", "maidenName", "maritalStatus", "middleName", "moGrossInc",
		"mothersMaidenName", "name", "nbrInHhold", "occupation", "prefix", "residencyStatus", "spouse", "studentType",
		"suffix", "tinType", "webAddr" })
