...
@JsonPropertyOrder({ "_Id", "componentName", "feeDtl", "version", "_uLog", "_cDtm", "_uDtm", "_vn", "_flags", "_schVn",
		"_cLogRef", "_cLog" })

public class PosnDepFee {
	...
	@JsonProperty("feeDtl")
	public FeeDtl getFeeDtl() {
		return feeDtl;
	}

	@JsonProperty("feeDtl")
	public void setFeeDtl(FeeDtl feeDtl) {
		this.feeDtl = feeDtl;
	}
